...
### 💡 Problema
A dificuldade estava em automatizar respostas a dúvidas recorrentes baseadas em documentos. Era necessário um sistema eficiente, que consultasse informações dentro de arquivos e retornasse respostas de forma clara e rápida.
...
- `MySQL`: uso com apoio
- `NetBeans/Eclipse`: uso com autonomia
- `Integração de documentos`: uso com autonomia
...
### 💡 Problema
A empresa usava planilhas do Excel para gerir dados de vendas, dificultando o acesso e a análise quando o volume de dados era grande. O desafio era transformar essas planilhas em um sistema visual e organizado.
